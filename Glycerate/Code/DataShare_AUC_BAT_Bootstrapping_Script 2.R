...
excel_sheets("../Datafiles/BDF_C2_water_vs_HFCS_PvsS_glycerate.xlsx")

Dataframe<-read_excel("../Datafiles/BDF_C2_water_vs_HFCS_PvsS_glycerate.xlsx",sheet = "Merged v2")
...
write.csv(Dataframemeltnas,file = "../Datafiles/Glycerate_NA_values.csv",row.names = FALSE)
...
b$Compound_temp<-paste("glycerate",b$genetics,b$treatment, sep = "_")
...
write.csv(bootmet,file = "../Datafiles/Bootstrapped_Result_Glycerate.csv",row.names = FALSE)
